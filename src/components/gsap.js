  ...
  render() {
    return (
      <div>
        ...
        <svg id="body" style={{ width: `50px` }} viewBox="0 0 113 89" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="1.5">
