...
export default class MyAnimation extends React.Component {
  componentDidMount() {
    ...
    const letterLoad = new TimelineLite({ repeat: -1, repeatDelay: 8 });
    ...
    const tlmLogo = new TimelineLite({
      paused: true,
      reversed: true
    });
  ...
  render() {
    return (
      <svg id="body" style={{ width: `113px`, height: `89px` }} viewBox="0 0 113 89" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="1.5">
